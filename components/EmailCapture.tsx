        ...
        <div className="max-w-2xl mx-auto text-center px-4">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 rounded-md border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-cta/30 focus:border-cta"
            />
            <button
              type="submit"
              disabled={status === "loading"}
              className="px-6 py-3 bg-cta hover:bg-cta-dark text-white font-semibold text-sm rounded-md transition-colors disabled:opacity-60"
            >
    ...
    <div className="bg-cream rounded-lg p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <input
          ...
          onChange={(e) => setEmail(e.target.value)}
          placeholder="your@email.com"
          className="w-full px-4 py-3 rounded-md border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-cta/30 focus:border-cta"
        />
        <button
          type="submit"
          disabled={status === "loading"}
          className="w-full px-6 py-3 bg-cta hover:bg-cta-dark text-white font-semibold text-sm rounded-md transition-colors disabled:opacity-60"
        >
          {status === "loading" ? "Sending..." : buttonText}
        </button>
      </form>
