        ...
        <div className="rounded-xl bg-white p-8 shadow-lg md:p-10 text-center">
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-3 max-w-sm mx-auto">
            <input
              ...
              className="w-full px-4 py-3 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-gold"
            />
            <button
              type="submit"
              disabled={emailStatus === 'loading'}
              className="btn-shine w-full px-6 py-3 bg-gold hover:bg-gold-dark text-white font-semibold rounded-lg transition-colors disabled:opacity-60"
            >
        ...
        <div className="rounded-xl bg-white p-8 shadow-lg md:p-10">
          ...
          <div className="mb-8 flex justify-center">
            <div
              ...
              style={{
                background: `conic-gradient(#C4973B ${score * (360 / 24)}deg, #E5E7EB 0deg)`,
              }}
            >
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:justify-center mb-6">
            <Link
              ...
              className="btn-shine rounded-lg bg-gold hover:bg-gold-dark px-6 py-3 text-center font-semibold text-white transition-colors"
            >
        ...
        <div className="space-y-3">
          {currentQ.answers.map((answer, idx) => (
            <button
              ...
              className="group w-full rounded-lg border-2 border-gray-200 bg-white p-4 text-left transition-all duration-200 hover:border-gold hover:bg-gold/5"
            >
              <p className="text-sm font-medium text-navy group-hover:text-gold-dark md:text-base">
                {answer.text}
              </p>
            </button>
          ))}
